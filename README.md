...
2. 📊 [Оптимизация разбиения на чанки](https://github.com/trofimovelijah/cocktail_qr/issues/2)
3. 🤖 Идеологическая переделка `AI-агента` (_неверная реализация_)
4. 🔧 Тюнинг промтов
5. 🎨 Тюнинг стилей ответа
6. 🐳 Контейнеризация тг-бота:
