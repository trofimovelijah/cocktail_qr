...
7. 🛠️ Отладка с другими инструментами работы с LLM: 
   ...
   - `CTranslate2`
8. 📜 Логирование кода
9. ⏳ [Оптимизация жизненного цикла функционирования тг-бота](https://github.com/trofimovelijah/cocktail_qr/issues/8)
10. 🍹 [Переделка бизнес-логики формирования рецептов](https://github.com/trofimovelijah/cocktail_qr/issues/5) с возможностью на выбор писателя, а не ингредиента
